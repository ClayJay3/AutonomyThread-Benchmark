...
public:
    ...
    void Start()
    {
        ...
        std::future<void> fuMainReturn = m_thMainThread.submit_task([this]()
        ...
        m_cdThreadRunningCondition.wait(lkStartLock, [this]
                                        { return this->m_eThreadState == eRunning || this->m_eThreadState == eStopping; });
    }
